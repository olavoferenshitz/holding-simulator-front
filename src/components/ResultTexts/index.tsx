    ...
    <Container>
      {result.saving >= 100000 ? (
        <>
          ...
          <Text>
            Nossos resultados mostram que optar por uma Holding pode economizar{' '}
            {priceFormatter.format(result.saving)} para sua família. Fazer
            doação em vida ou esperar pelo inventário será muito mais custoso,
            podendo resultar em uma perda de até 30% do seu patrimônio, afetando
            o futuro financeiro dos seus entes queridos.
          </Text>
          <Text>
            Com nosso método comprovado, o Legado80, sua família vai economizar
            mais de 80% em comparação com o tradicional inventário. Imagine a
            segurança de proteger não apenas seu patrimônio, mas também o futuro
            da sua geração.
          </Text>
          {simulation.age > 60 && (
            <Text>
          ...
          {simulation.rentalProperty === 'sim' && (
            <Text>
              ...
              aluguéis, você poderá agora pagar entre 11% e 14,5%, economizando
              consideravelmente em seus encargos fiscais.
            </Text>
          )}
        ...
        <>
          ...
          <Text>
            Entendemos que a Holding Familiar e o Método Legado80 podem não ser
            a escolha ideal para você agora. Mas não se preocupe, há
            alternativas valiosas para proteger seu patrimônio e garantir o
            bem-estar da sua família.
          </Text>
          <Text>
            Se nossa abordagem atual não atende às suas necessidades, considere
            opções igualmente eficazes, como um testamento bem elaborado, uma
            doação em vida com reserva de usufruto, um seguro de vida ou um
            plano de previdência privada específico.
          </Text>
          {simulation.age < 30 && (
            <Text>
              Além disso, aos {simulation.age} anos, considerar a criação de uma
              Holding é sensato se você está no processo de construir seu
              patrimônio, planeja adquirir um imóvel, está pensando em casar-se
              ou deseja investir seu dinheiro com sabedoria.
            </Text>
          )}
          <Text>
